...
class Start_Page5_NotMatched(QMainWindow):
    def __init__(self):
        super().__init__()

        self.window = uic.loadUi("UI_Designs/Page_5_Not_Matched.ui", self)
        ...
        self.examiner_no = self.findChild(QLineEdit, "probe_idLineEdit_5")
        self.examiner_name = self.findChild(QLineEdit, "probe_idLineEdit_6")
        self.remarks = self.findChild(QLineEdit, "probe_idLineEdit_7")
        self.case_image = self.findChild(QLabel, "label_8")

        self.pg5_n_btn1 = self.findChild(QPushButton, "pushButton_3")
        self.pg5_n_btn2 = self.findChild(QPushButton, "pushButton_2")
        self.pg5_n_btn3 = self.findChild(QPushButton, "pushButton")
